...
function Terrain(){
	...
	this.render_tiles = function(tilemap, tilemap_index){
		...
		for(var i in tilemap){
			...
			var x = tilemap[i].x;
			var z = tilemap[i].z;
			var height = (Math.round(tilemap[i].height * 10) * 50) - 150;
			...
			chunk_geo_sides.faces.push( new THREE.Face3( (i*8), (i*8)+2, (i*8)+3 ) );
			chunk_geo_sides.faces.push( new THREE.Face3( (i*8), (i*8)+3, (i*8)+1 ) );
			chunk_geo_sides.faces.push( new THREE.Face3( (i*8)+4, (i*8)+6, (i*8)+7 ) );
			chunk_geo_sides.faces.push( new THREE.Face3( (i*8)+4, (i*8)+7, (i*8)+5 ) );
		...
		chunk_geo.merge( chunk_geo_sides, chunk_geo_sides.matrix, 1 );
...
// chunk = new THREE.Mesh( new THREE.BoxGeometry(50,50,50), self.tile_textures );
