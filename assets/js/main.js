...
function Network(){
	...
	this.get_map_data = function(origin_point, distance){
		...
		// only one point
		tmp_origin_points = [origin_point];
...
function Terrain(){
	...
	this.render_tiles = function(tilemap, tilemap_index){
		...
		var chunk_geometry = new THREE.PlaneGeometry( self.tile_width * 2 * cube_size, self.tile_width * 2 * cube_size, cube_size * 2, cube_size * 2 );
// console.log( tilemap.length, chunk.geometry.vertices.length )
		for(var i in tilemap){
			...
			// chunk.geometry.vertices[i].x += 50;
			...
			// var material_index = Math.round(Math.random()*10);;
			// chunk_geometry.faces[i*4].materialIndex = material_index;
			// chunk_geometry.faces[(i*4) + 1].materialIndex = material_index;

			// chunk_geometry.vertices[i].z = tmp_height;
			chunk_geometry.faces[ (x * cube_size * 8) + (z*4) ].materialIndex = 2;
			chunk_geometry.faces[ (x * cube_size * 8) + (z*4) + 1 ].materialIndex = 2;

			tmp_height = Math.random() * 50;
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) ].z += tmp_height;
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) + 1 ].z += tmp_height;
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) ].z += tmp_height;
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) + 1 ].z += tmp_height;

			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) ].x -= (this.tile_width*z);
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) + 1 ].x -= (this.tile_width*z);
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) ].x -= (this.tile_width*z);
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) + 1 ].x -= (this.tile_width*z);

			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) ].y += (this.tile_width*x);
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) + 1 ].y += (this.tile_width*x);
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) ].y += (this.tile_width*x);
			chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) + 1 ].y += (this.tile_width*x);

			// console.log( chunk_geometry.vertices[ (x * cube_size * 8) + (z*4) + 1 ] )//.z += tmp_height;

			if(z == (cube_size-1)){
				chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) + 2 ].x -= (this.tile_width*cube_size) - 10;
				chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) + 2 ].x -= (this.tile_width*cube_size) - 0;
			}

			if(x == (cube_size-1)){
				chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (2*(((cube_size*2)+1)*1)) + (z*2) ].y += (this.tile_width*cube_size);
				chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (2*(((cube_size*2)+1)*1)) + (z*2) + 1 ].y += (this.tile_width*cube_size)
			}
		}

		// for(var i in cube_size){
			// chunk_geometry.vertices[ cube_size*cube_size ].x += 100;
		// }
		...
		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) ].x -= (this.tile_width/2*z);
		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) + 1 ].x -= (this.tile_width/2*z);
		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) ].x -= (this.tile_width/2*z);
		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) + 1 ].x -= (this.tile_width/2*z);

		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) ].y += (this.tile_width/2*x);
		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (z*2) + 1 ].y += (this.tile_width/2*x);
		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) ].y += (this.tile_width/2*x);
		// chunk_geometry.vertices[ (x * (((cube_size*2)+1)*2) ) + (((cube_size*2)+1)*1) + (z*2) + 1 ].y += (this.tile_width/2*x);

		var chunk = new THREE.Mesh(chunk_geometry, self.tile_textures);
		// chunk.geometry.vertices[0].z += 50;
		// chunk.geometry.vertices[1].z += 50;
		// chunk.geometry.vertices[ (cube_size*2) ].z += 50;
		// chunk.geometry.vertices[ (cube_size*2) +2].z += 50;

		// chunk.geometry.vertices[cube_size+1].z += 50;
		// chunk.geometry.vertices[1367].z += 50;


		var origin_x = (index_to_coords(tilemap_index)[0] - start_origin[0]) * (terrain.tile_width*2);
		var origin_z = (index_to_coords(tilemap_index)[1] - start_origin[1]) * (terrain.tile_width*2);
