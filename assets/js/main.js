...
function Terrain(){
	...
	this.chunk_worker = new Worker('assets/workers/chunks.js');

	this.chunk_worker.addEventListener('message', function(e) {
	...
	this.update_tilemaps = function(tilemaps){
		...
		// this.chunk_worker.postMessage('Hello!');
		this.chunk_worker.postMessage(tilemaps);
		return false;
